---
name: Bug report
about: Report a bug or unexpected behavior in bevy_ecs_typewriter
...
- bevy_ecs_typewriter version (if applicable)
...
3. How are you using bevy_ecs_typewriter? (e.g., integrating it into a Bevy app, building as a library)
